...
$\circ$ \textbf{Mesh-to-mesh collisions:} Implemented a new, high-performance collision detection system based on point-to-triangle intersection tests. This allows for mesh-accurate collisions between vessels, and between vessels and planetary surface objects.\\
